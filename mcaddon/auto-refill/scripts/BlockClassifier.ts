...
const ID_KEYWORDS: ReadonlyArray<readonly [keywords: readonly string[], tool: ToolCategory]> = [
  [
    [
      "ore", "stone", "deepslate", "obsidian", "anvil", "rail", "furnace",
      "spawner", "lantern", "terracotta", "concrete", "prismarine", "end_stone",
      "hopper", "chain", "bars", "lodestone", "respawn_anchor", "grindstone",
      "enchanting", "amethyst", "dripstone", "copper", "quartz", "netherite_block",
      "iron_block", "gold_block", "diamond_block", "emerald_block", "bell",
      "brewing_stand", "cauldron", "_wall", "brick", "iron_door", "iron_trapdoor",
    ],
    "pickaxe",
  ],
  [
    [
      "log", "stem", "stripped_", "plank", "fence", "door", "trapdoor", "chest",
      "bookshelf", "banner", "barrel", "campfire", "ladder", "sign", "note_block",
      "jukebox", "beehive", "bee_nest", "composter", "loom", "lectern", "table",
      "pumpkin", "mushroom_block",
    ],
    "axe",
  ],
  [
    [
      "dirt", "grass_block", "sand", "gravel", "clay", "snow", "mud", "podzol",
      "mycelium", "farmland", "path", "soul_sand", "soul_soil", "rooted_dirt",
      "powder_snow",
    ],
    "shovel",
  ],
  [
    [
      "hay_block", "dried_kelp_block", "sculk", "sponge", "moss_block", "target",
