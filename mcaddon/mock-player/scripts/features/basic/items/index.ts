...
//   - mainhand            主手置换
//   - drop                丢弃选中物品（掉落物形式）（背包扫描 → 置换到主手，决策在 rules/items/MainhandPolicy）
...
export { dropSelectedItem } from "./drop";
export { swapMainhandWithBot, swapOffhandWithBot, swapEquipmentWithBot, SwapResult } from "./equip";
export { EQUIP_SLOT_MAP, SWAP_SLOTS } from "./EquipmentSlots";
export { useItemOnce, startUseItem, stopUseItem, registerUiSubscriptions, UseItemResult } from "./useItem";
