...
export const BOT_TASKS = [mineTask, placeTask, attackTask, wanderTask, fishingTask, followTask, woodcutTask] as const;
...
export { mineTask, placeTask, attackTask, wanderTask, fishingTask, followTask, woodcutTask };
export { pauseFollowTask, resumeFollowTask, isFollowPaused } from "./followTask";
export {
  defineLoopTask,
  TASK_DONE,
  warnTaskError,
