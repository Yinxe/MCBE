...
const HELP_SECTIONS: { title: string; content: string[] }[] = [
  ...
  },
  {
    ...
    content: [
      ...
      `${color.info}/mp:list ${color.muted}- 列出所有假人`,
      ...
      `${color.info}/mp:kill <假人> ${color.muted}- 杀死指定假人`,
      `${color.info}/mp:tp <假人> ${color.muted}- 传送到假人身边`,
      `${color.info}/mp:tphere <假人> ${color.muted}- 将假人传送到身边`,
      `${color.info}/mp:tag <假人> <add|remove|list> [标签] ${color.muted}- 管理标签`,
